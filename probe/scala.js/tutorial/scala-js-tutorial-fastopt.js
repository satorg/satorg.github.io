...
ScalaJS.c.Ltutorial_webapp_TutorialApp$.prototype.init___ = (function() {
  ...
  this.greetings$1 = ScalaJS.as.scm_Queue(ScalaJS.m.scm_Queue$().apply__sc_Seq__sc_GenTraversable(new ScalaJS.c.sjs_js_WrappedArray().init___sjs_js_Array(["Hello, First", "Hello, Second", "Hello, Third"])));
  return this
});
ScalaJS.c.Ltutorial_webapp_TutorialApp$.prototype.appendGreeting__p1__V = (function() {
  var greeting = (this.greetings$1.isEmpty__Z() ? "No more greetings for you, sorry!" : ScalaJS.as.T(this.greetings$1.dequeue__O()));
  var jsx$1 = (0, ScalaJS.g["jQuery"])("body");
  var s = new ScalaJS.c.s_StringContext().init___sc_Seq(new ScalaJS.c.sjs_js_WrappedArray().init___sjs_js_Array(["<p>", "</p>"])).s__sc_Seq__T(new ScalaJS.c.sjs_js_WrappedArray().init___sjs_js_Array([greeting]));
  jsx$1["append"](s)
});
ScalaJS.c.Ltutorial_webapp_TutorialApp$.prototype.main__V = (function() {
  (0, ScalaJS.g["jQuery"])((function() {
    ScalaJS.m.Ltutorial_webapp_TutorialApp$().tutorial$webapp$TutorialApp$$setupUI__V()
  }))
});
ScalaJS.c.Ltutorial_webapp_TutorialApp$.prototype.$$js$exported$meth$main__O = (function() {
  this.main__V()
});
ScalaJS.c.Ltutorial_webapp_TutorialApp$.prototype.tutorial$webapp$TutorialApp$$setupUI__V = (function() {
  (0, ScalaJS.g["jQuery"])("<button type=\"button\">Greet me again!</button>")["click"]((function() {
    var this$1 = ScalaJS.m.Ltutorial_webapp_TutorialApp$();
    this$1.appendGreeting__p1__V()
  }))["appendTo"]((0, ScalaJS.g["jQuery"])("body"));
  this.appendGreeting__p1__V()
});
...
ScalaJS.as.scm_LinkedListLike$$anon$1 = (function(obj) {
  return ((ScalaJS.is.scm_LinkedListLike$$anon$1(obj) || (obj === null)) ? obj : ScalaJS.throwClassCastException(obj, "scala.collection.mutable.LinkedListLike$$anon$1"))
});
...
ScalaJS.asArrayOf.scm_LinkedListLike$$anon$1 = (function(obj, depth) {
  return ((ScalaJS.isArrayOf.scm_LinkedListLike$$anon$1(obj, depth) || (obj === null)) ? obj : ScalaJS.throwArrayCastException(obj, "Lscala.collection.mutable.LinkedListLike$$anon$1;", depth))
});
...
ScalaJS.d.scm_LinkedList$ = new ScalaJS.ClassTypeData({
  scm_LinkedList$: 0
}, false, "scala.collection.mutable.LinkedList$", ScalaJS.d.scg_SeqFactory, {
  scm_LinkedList$: 1,
  scg_SeqFactory: 1,
  scg_GenSeqFactory: 1,
  scg_GenTraversableFactory: 1,
...
ScalaJS.d.scm_MutableList$ = new ScalaJS.ClassTypeData({
  scm_MutableList$: 0
}, false, "scala.collection.mutable.MutableList$", ScalaJS.d.scg_SeqFactory, {
  scm_MutableList$: 1,
  scg_SeqFactory: 1,
  scg_GenSeqFactory: 1,
  scg_GenTraversableFactory: 1,
...
ScalaJS.d.scm_Queue$ = new ScalaJS.ClassTypeData({
  scm_Queue$: 0
}, false, "scala.collection.mutable.Queue$", ScalaJS.d.scg_SeqFactory, {
  scm_Queue$: 1,
  scg_SeqFactory: 1,
  scg_GenSeqFactory: 1,
  scg_GenTraversableFactory: 1,
...
}, true, "scala.collection.mutable.LinkedListLike", (void 0), {
...
ScalaJS.d.scm_Seq = new ScalaJS.ClassTypeData({
  scm_Seq: 0
}, true, "scala.collection.mutable.Seq", (void 0), {
  scm_Seq: 1,
  scm_Iterable: 1,
  scm_Traversable: 1,
  sc_Traversable: 1,
...
ScalaJS.c.scm_MutableList.prototype.seq__sc_LinearSeq = (function() {
  return this
});
